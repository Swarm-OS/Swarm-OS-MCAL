...
typedef union __STM32F4xx_I2C_CR1_Regdef
{
    struct
    {
        volatile uint16_t PE            :   1;  // Bit  0
        volatile uint16_t SMBUS         :   1;  // Bit  1
        const uint16_t _reserved_2      :   1;  // Bit  2
        volatile uint16_t SMBTYPE       :   1;  // Bit  3
        volatile uint16_t ENARP         :   1;  // Bit  4
        volatile uint16_t ENPEC         :   1;  // Bit  5
        volatile uint16_t ENGC          :   1;  // Bit  6
        volatile uint16_t NOSTRETCH     :   1;  // Bit  7
        volatile uint16_t START         :   1;  // Bit  8
        volatile uint16_t STOP          :   1;  // Bit  9
        volatile uint16_t ACK           :   1;  // Bit 10
        volatile uint16_t POS           :   1;  // Bit 11
        volatile uint16_t PEC           :   1;  // Bit 12
        volatile uint16_t ALERT         :   1;  // Bit 13
        const uint16_t _reserved_1      :   1;  // Bit 14
        volatile uint16_t SWRST         :   1;  // Bit 15
    };
    uint16_t raw;
...
typedef union __STM32F4xx_I2C_CR2_Regdef
{
    struct
    {
        volatile uint16_t FREQ          :   6;  // Byte 0, Bit  0- 5
        const uint16_t _reserved_2      :   2;  // Byte 0, Bit  6- 7
        volatile uint16_t ITERREN       :   1;  // Byte 1, Bit     8
        volatile uint16_t ITEVTEN       :   1;  // Byte 1, Bit     9
        volatile uint16_t ITBUFEN       :   1;  // Byte 1, Bit    10
        volatile uint16_t DMAEN         :   1;  // Byte 1, Bit    11
        volatile uint16_t LAST          :   1;  // Byte 1, Bit    12
        const uint16_t _reserved_1      :   3;  // Byte 1, Bit 13-15
    };
    uint16_t raw;
...
typedef union __STM32F4xx_I2C_OAR2_Regdef
{
    struct
    {
        volatile uint16_t ENDUAL        :   1;  // Bit    0
        volatile uint16_t ADD2          :   7;  // Bit 1- 7
        const uint16_t _reserved_1      :   8;  // Bit 8-15
...
typedef union __STM32F4xx_I2C_DR_Regdef
{
    struct
    {
        volatile uint16_t DR            :   8;  // Bit 0- 7
        const uint16_t _reserved_1      :   8;  // Bit 8-15
...
typedef union __STM32F4xx_I2C_SR1_Regdef
{
    struct
    {
        volatile uint16_t SB            :   1;  // Bit  0
        volatile uint16_t ADDR          :   1;  // Bit  1
        volatile uint16_t BTF           :   1;  // Bit  2
        volatile uint16_t ADD10         :   1;  // Bit  3
        volatile uint16_t STOPF         :   1;  // Bit  4
        const uint16_t __reserved_2     :   1;  // Bit  5
        volatile uint16_t RxNE          :   1;  // Bit  6
        volatile uint16_t TxE           :   1;  // Bit  7
        volatile uint16_t BERR          :   1;  // Bit  8
        volatile uint16_t ARLO          :   1;  // Bit  9
        volatile uint16_t AF            :   1;  // Bit 10
        volatile uint16_t OVR           :   1;  // Bit 11
        volatile uint16_t PEC_ERR       :   1;  // Bit 12
        const uint16_t _reserved_1      :   1;  // Bit 13
        volatile uint16_t TIMEOUT       :   1;  // Bit 14
        volatile uint16_t SMBALER       :   1;  // Bit 15
    };
    uint16_t raw;
...
typedef union __STM32F4xx_I2C_SR2_Regdef
{
    struct
    {
        volatile uint16_t MSL           :   1;  // Bit    0
        volatile uint16_t BUSY          :   1;  // Bit    1
        volatile uint16_t TRA           :   1;  // Bit    2
        const uint16_t __reserved       :   1;  // Bit    3
        volatile uint16_t GENCALL       :   1;  // Bit    4
        volatile uint16_t SMBDEFAULT    :   1;  // Bit    5
        volatile uint16_t SMBHOST       :   1;  // Bit    6
        volatile uint16_t DAUALF        :   1;  // Bit    7
        volatile uint16_t PEC           :   8;  // Bit 8-15
    };
    uint16_t raw;
...
typedef union __STM32F4xx_I2C_TRISE_Regdef
{
    struct
    {
        volatile uint16_t TRISE         :   6;  // Bit 0- 5
        const uint16_t __reserved_2     :   2;  // Bit 6- 7
        const uint16_t __reserved_1     :   8;  // Bit 8-15
    };
    uint16_t raw;
...
typedef union __STM32F4xx_I2C_FLTR_Regdef
{
    struct
    {
        volatile uint16_t DNF           :   4;  // Bit 0- 3
        volatile uint16_t ANOFF         :   4;  // Bit    4
        const uint16_t __reserved_2     :   3;  // Bit 5- 7
        const uint16_t __reserved_1     :   8;  // Bit 8-15
    };
    uint16_t raw;
